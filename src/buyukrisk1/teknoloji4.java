 ...
 * @author Ozge
 */
public class teknoloji4 extends javax.swing.JFrame {

    /**
     * Creates new form teknoloji4
     */
    public teknoloji4() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Türkiye'de TÜBİTAK tarafından geliştirilip 27 Aralık 2005’te yayınlanan bir GNU/Linux dağıtımı olan işletim sistemi?");
...
jButton3.setBackground(Color.red);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teknoloji4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teknoloji4().setVisible(true);
            }
        });
    }

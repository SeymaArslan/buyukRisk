...
public class ulkeler1 extends javax.swing.JFrame {

    /**
     * Creates new form ulkeler1
     */
    public ulkeler1() {
   ...
   //  risk1 yeni= new risk1();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adana ve Mersin arasında olduğu için (iki büyük şehir arasında diye) il olamayan en kalabalık ilçemiz hangisidir?");

        jLabel2.setFont(new java.awt.Font("Calibri Light", 1, 24)); // NOI18N
        jLabel2.setText("COĞRAFYA");

        jButton1.setFont(new java.awt.Font("Calibri Light", 1, 14)); // NOI18N
        jButton1.setText("Mut");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       JLabel puan = new JLabel();
        ...
        yeni.jSpinner1.setValue(c);
        
        jButton1.setBackground(Color.red);
        jButton2.setBackground(Color.green);
        jButton2.setVisible(true);
        jButton1.setVisible(true); 
        yeni.jSpinner1.setVisible(true);
 ...
 jButton4.setBackground(Color.red);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ulkeler1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

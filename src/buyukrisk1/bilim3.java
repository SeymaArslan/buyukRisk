...
public class bilim3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Hangisi bataklık çiçeğidir?");

        jButton1.setFont(new java.awt.Font("Calibri Light", 1, 18)); // NOI18N
        jButton1.setText("Aslanağzı");
 ...
 jButton3.setBackground(Color.red);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bilim3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

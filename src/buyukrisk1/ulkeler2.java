 ...
 * @author Ozge
 */
public class ulkeler2 extends javax.swing.JFrame {
 
 
    /**
     * Creates new form ulkeler2
     */
    public ulkeler2() {
        initComponents();
        
 /* getContentPane().setLayout(new BorderLayout());
  JLabel jLabel1 = new JLabel(new ImageIcon("C:\\Users\\Ozge\\Desktop.png"));
  ...
  jLabel1.setLayout(new FlowLayout());*/
    ...
    private void initComponents() {
        ...
        jLabel3.setText("     İtalya'daki en büyük aktif yanardağ hangisidir?");
 ...
 jButton3.setBackground(Color.green);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ulkeler2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author Ozge
 */
public class teknoloji2 extends javax.swing.JFrame {

    /**
     * Creates new form teknoloji2
     */
    public teknoloji2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Aşağıdaki nesnelerden hangisi olayı başlatmak için ActionEvent kullanmaz?");
...
jButton4.setBackground(Color.red);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teknoloji2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teknoloji2().setVisible(true);
            }
        });
    }

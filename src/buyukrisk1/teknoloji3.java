 ...
 * @author Ozge
 */
public class teknoloji3 extends javax.swing.JFrame {

    /**
     * Creates new form teknoloji3
     */
    public teknoloji3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Aşağıdaki veri türlerinden hangisi hafızada 2 byte’dan daha fazla yer kaplar?   ");
...
jButton4.setBackground(Color.red);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teknoloji3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teknoloji3().setVisible(true);
            }
        });
    }
